        ...
        for(let i = 0; i < customMarkers?.length; i++){
          ...
          if(customMarkers[i]?.imageUrl){
            if(customMarkers[i]?.reviewCount > 1 && customMarkers[i]?.reviewCount < 10){
              content = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMark" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/><div class="reviewCount width55">'+ customMarkers[i].reviewCount +'</div></div>'
              contentFocus = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMarkFocus" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/><div class="reviewCount width55">'+ customMarkers[i].reviewCount +'</div></div>'
            } else if(customMarkers[i]?.reviewCount > 9 && customMarkers[i]?.reviewCount < 100 ) {
              content = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMark" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/><div class="reviewCount width75">'+ customMarkers[i].reviewCount +'</div></div>'
              contentFocus = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMarkFocus" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/><div class="reviewCount width75">'+ customMarkers[i].reviewCount +'</div></div>'
            } else if(customMarkers[i]?.reviewCount > 99) {
              content = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMark" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/><div class="reviewCount width95">99+</div></div>'
              contentFocus = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMarkFocus" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/><div class="reviewCount width95">99+</div></div>'
            } else {
              content = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMark" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/></div>'
              contentFocus = '<div class="divstyle" tabindex=' + i + ' id=' + "imageDiv"+ i +' onclick="panTo('+ customMarkers[i].y + ' , ' + customMarkers[i].x +' ); customDivClick(' + i + ', ' + customMarkers.length + ', ' + markers.length + ');" ><img class="imageMarkFocus" /><img class="realImage" src="'+ 'https://d3uii6bdiuxwa3.cloudfront.net/' + customMarkers[i].imageUrl + '?w=300&h=300" onerror="this.src='+ "'https://d3uii6bdiuxwa3.cloudfront.net/dev/common/defaultmarker.jpg'" + ';"/></div>'
            }
          } else {
            if(customMarkers[i]?.reviewCount > 1 && customMarkers[i]?.reviewCount < 10){
